...
echo "Building..."
g++ main_pr.cpp processor_PASH.cpp -I../Stack/headers_stack -I.. ../Stack/buffer.cpp ../Stack/calculator.cpp ../Stack/operationsCalc.cpp ../Stack/safetyOfStack.cpp ../Stack/stackFuncs.cpp ../Stack/stackJumps.cpp  \
