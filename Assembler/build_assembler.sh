...
echo "Building..."
g++ main_asm.cpp assembler.cpp labels_comments.cpp Utils_asm.cpp -I../Stack/headers_stack -I..//Processor -I.. ../Stack/buffer.cpp ../Stack/calculator.cpp ../Stack/operationsCalc.cpp ../Stack/safetyOfStack.cpp ../Stack/stackFuncs.cpp ../Stack/stackJumps.cpp  \
 -o Assembler.out -D _DEBUG -g -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-align -Wcast-qual \
