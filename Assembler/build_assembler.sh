...
echo "Building..."
g++ main_asm.cpp assembler.cpp -I../Stack/headers_stack -I..//Processor -I.. ../Stack/buffer.cpp ../Stack/calculator.cpp ../Stack/operationsCalc.cpp ../Stack/safetyOfStack.cpp ../Stack/stackFuncs.cpp  \
